...
def pil_to_latents(pil_image, sd_pipe, return_image=False):
    image_tensor = transforms.Compose([transforms.PILToTensor()])(pil_image).to(sd_pipe.unet.device).to(sd_pipe.unet.dtype)
